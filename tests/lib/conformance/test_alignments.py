...
def make_pm4py_alignments_stub(return_value):
    ...
    algorithm_mod = types.ModuleType("pm4py.algo.conformance.alignments.algorithm")
    ...
    return {
        ...
        "pm4py.algo.conformance.alignments.algorithm": algorithm_mod,
